...
public static class SunshineMath
{
	...
	/// </summary>
	public static Vector2 xy(Vector3 self) { return new Vector2(self.x, self.y); }
	
	/// <summary>
	/// Shader-style swizzling.  Same as float.xy
	/// </summary>
	public static Vector2 xy(Vector4 self) { return new Vector2(self.x, self.y); }
	
	/// <summary>
	/// Shader-style swizzling.  Same as float.xyz
	/// </summary>
	public static Vector3 xyz(Vector4 self) { return new Vector3(self.x, self.y, self.z); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0)
	/// </summary>
	public static Vector3 xy0(Vector2 self) { return new Vector3(self.x, self.y, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0)
	/// </summary>
	public static Vector3 xy0(Vector3 self) { return new Vector3(self.x, self.y, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0)
	/// </summary>
	public static Vector3 xy0(Vector4 self) { return new Vector3(self.x, self.y, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0, 0)
	/// </summary>
	public static Vector4 xy00(Vector2 self) { return new Vector4(self.x, self.y, 0f, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0, 0)
	/// </summary>
	public static Vector4 xy00(Vector3 self) { return new Vector4(self.x, self.y, 0f, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, 0, 0)
	/// </summary>
	public static Vector4 xy00(Vector4 self) { return new Vector4(self.x, self.y, 0f, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, z, 0)
	/// </summary>
	public static Vector4 xyz0(Vector3 self) { return new Vector4(self.x, self.y, self.z, 0f); }
	
	/// <summary>
	/// Same as new Vector3(x, y, z, 0)
	/// </summary>
	public static Vector4 xyz0(Vector4 self) { return new Vector4(self.x, self.y, self.z, 0f); }
	...
	public static int RelativeResolutionDivisor(SunshineRelativeResolutions resolution)
	{
		switch(resolution)
		{
		case SunshineRelativeResolutions.Full:		return 1;
		case SunshineRelativeResolutions.Half:		return 2;
		case SunshineRelativeResolutions.Third:		return 3;
		case SunshineRelativeResolutions.Quarter:	return 4;
		case SunshineRelativeResolutions.Fifth:		return 5;
		case SunshineRelativeResolutions.Sixth:		return 6;
		case SunshineRelativeResolutions.Seventh:	return 7;
		case SunshineRelativeResolutions.Eighth:	return 8;
		}
		return 1;
	}
	...
	/// </param>		
	public static float QuantizeValue(float number, int resolution) { return QuantizeValue(number, 1f / (float)resolution); }
	...
	/// The last result this method returned
	/// </param>
	public static float QuantizeValueWithoutFlicker(float number, int resolution, float lastResult) { return QuantizeValueWithoutFlicker(number, 1f / (float)resolution, lastResult); }
