...
public class Sunshine : MonoBehaviour
{
	...
	public static string FormatMessage(string message) { return string.Format("Sunshine {0}: {1}", Version, message); }
	...
	public LayerMask GetCascadeOccluders(int cascade)
	{
		...
		switch(cascade)
		{
		case 0: return Occluders;
		case 1: return UsePerCascadeOccluders ? Occluders1 : Occluders;
		case 2: return UsePerCascadeOccluders ? Occluders2 : Occluders;
		case 3: return UsePerCascadeOccluders ? Occluders3 : Occluders;
		}
		return Occluders;
	}
	...
	public float ShadowFilterKernelRadius
	{
		get
		{
			switch(ShadowFilter)
			{
			case SunshineShadowFilters.PCF2x2: return 1f;
			case SunshineShadowFilters.PCF3x3: return 1.5f;
			case SunshineShadowFilters.PCF4x4: return 2f;
			}
			return 0.5f;
		}
	}
	...
	/// </param>
	public float LightmapTexelPhysicalSize(int cascadeID) { return (SunLightCameras[cascadeID].orthographicSize * 2f) / (float)CascadeMapResolution; }
	
	/// <summary>
	/// Gets the shadow bias, a depth offset used to avoid "Shadow Acne"
	/// </summary>
	public float ShadowBias(int cID) { return SunLight.shadowBias * (1f + LightmapTexelPhysicalSize(cID) * 2f); }
	...
	/// The cascade index
	/// </param>
	public float ShadowSlopeBias(int cID) { return SunLight.shadowNormalBias * LightmapTexelPhysicalSize(cID) * 10f; }
	...
	public SunshineMath.BoundingSphere CustomBounds { get { return new SunshineMath.BoundingSphere() { origin = CustomLightBoundsOrigin.position, radius = CustomLightBoundsRadius }; } }
	...
	/// The cascade index.
	/// </param>
	public Rect CascadeRect(int cID) { return CascadeRects[cID]; }
	...
	/// The cascade index
	/// </param>
	public float CascadeNearClip(int cID) { return CascadeNearClipScale(cID) * LightDistance; }
	/// <summary>
	...
	/// The cascade index
	/// </param>
	public float CascadeFarClip(int cID) { return CascadeFarClipScale(cID) * LightDistance; }
	/// <summary>
	...
	public float CascadeFarClipScale(int cID)
	{
		...
		if(UseManualCascadeSplits)
		{
			...
			for(int i = 0; i <= cID; i++)
			{
				switch(i)
				{
				case 0: farClip += (1.0f - farClip) * ManualCascadeSplit0; break;
				case 1: farClip += (1.0f - farClip) * ManualCascadeSplit1; break;
				case 2: farClip += (1.0f - farClip) * ManualCascadeSplit2; break;
				}
			}
		}
		else
